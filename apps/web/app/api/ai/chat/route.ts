    ...
    const result = streamText({
      ...
      async onStepFinish({ toolResults }) {
        ...
        for (const tr of toolResults) {
          try {
            const entry = tr as unknown as { toolName?: string; result?: Record<string, unknown> };
